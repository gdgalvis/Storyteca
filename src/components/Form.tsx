...
const questions = {
  ...
  es: [
    ...
    { label: '¿Cuál es tu edad?', type: 'number', name: 'age' },
    { label: '¿Qué tipo de historia es tu favorita?', type: 'select', name: 'storyType', options: [{ value: 'adventure', text: 'Aventura' }, { value: 'fairy_tale', text: 'Cuento de Hadas' }, { value: 'mystery', text: 'Misterio' }, { value: 'funny_story', text: 'Historia Divertida' }, { value: 'animal_story', text: 'Historia de Animales' }, { value: 'space_adventure', text: 'Aventura Espacial' }] },
